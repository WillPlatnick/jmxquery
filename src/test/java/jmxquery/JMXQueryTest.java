...
public class JMXQueryTest {
    ...
    public void setUp() throws Exception {
        ...
        when(jmxProvider.getConnector(any(JMXServiceURL.class), ArgumentMatchers.isNull())).thenReturn(jmxConnector);
    ...
    private void assertResponseWas(int status, String message) {
        ...
        assertEquals(outputStream.toString(), message + System.lineSeparator());
    }
